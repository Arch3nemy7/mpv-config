...
local function main()
    ...
    if url ~= nil then
        ...
        if string.match(url, "www.youtube.com/watch%?v=([a-zA-Z0-9-_]+)&?.*$") ~= nil or
            string.match(url, "youtu.be/([a-zA-Z0-9-_]+)&?.*$") ~= nil then
        ...
        elseif string.match(url, "listen.moe/.*stream$") ~= nil or string.match(url, "listen.moe/.*opus$") ~= nil or
            string.match(url, "listen.moe/.*fallback$") ~= nil or string.match(url, "listen.moe/.*m3u$") ~= nil then
